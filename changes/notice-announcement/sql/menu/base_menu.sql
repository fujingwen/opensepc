...
INSERT INTO "master"."sys_menu" (menu_id, menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark)
VALUES
  (2029122000000000201, '系统公告', 2029122000000000002, 1, 'system', 'notice/system/index', 1, 0, 'C', '0', '0', 'notice:systemNotice:list', 'bell', 103, 1, now(), NULL, NULL, '系统公告页面'),
...
INSERT INTO "master"."sys_menu" (menu_id, menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark)
VALUES
  (2029122000000000211, '查询', 2029122000000000201, 1, '', '', 1, 0, 'F', '0', '0', 'notice:systemNotice:query', '#', 103, 1, now(), NULL, NULL, ''),
  (2029122000000000212, '新增', 2029122000000000201, 2, '', '', 1, 0, 'F', '0', '0', 'notice:systemNotice:add', '#', 103, 1, now(), NULL, NULL, ''),
  (2029122000000000213, '删除', 2029122000000000201, 3, '', '', 1, 0, 'F', '0', '0', 'notice:systemNotice:remove', '#', 103, 1, now(), NULL, NULL, ''),
